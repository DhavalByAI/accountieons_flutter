...
import 'bills_return_controller.dart';

class BillsReturnScreen extends StatelessWidget {
  const BillsReturnScreen({super.key});
                ...
                onPressed: () {
                  bottomSheet(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            GetBuilder<BillsReturnController>(
                              initState: (_) {},
                              builder: (_) {
                                return cFormField(
                                    title: 'Customer',
